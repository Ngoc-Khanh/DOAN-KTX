...
<body>
    ...
    <div class="container">
        ...
        if ($result->num_rows > 0) {
            ...
            echo "<p>Mã sinh viên: <input type='text' name ='txtMaSV' value='$maSV' disabled></p>";
            echo "<p>Họ và tên: <input type='text' name='txtHoTen' value='$hoTen' disabled></p>";
            echo "<p>Giới tính: <input type='text' name='txtGioiTinh' value='$gioiTinh' disabled></p>";
