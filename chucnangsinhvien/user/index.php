...
<div>
    <div class="container-fluid">
        <div class="row nenxanh">
            ...
            <div class="col-md-5     cantop">
                <center>
                    <h5> KÝ TÚC XÁ - Đại Học Công Nghệ Giao Thông Vận Tải</h5>
                    <h7> 54 Triều Khúc - Hà Nội</h7>
                </center>
            </div>
            <div class="col-md-3 cantop">
                <center>
                ...
                <nav class="menu">
                    <ul>
                        ...
                        if (isset($_SESSION['sv'])) { ?>
                            <li><a class="ad" onclick="XacNhan()">Đăng Xuất</a></li>
                        <?php } else { ?>
        ...
        <div class="col-2 nenbac" style="margin-left: -20px">
            <nav id="menu">
                <ul>
                    ...
                    <li><a href="index.php?action=capnhatthongtin">Thông Tin Sinh Viên</a></li>
                    ...
                    <li><a onclick="XacNhan()">Đăng Xuất</a></li>
                </ul>
            </nav>
        </div>
        <div class="col-8 ">
